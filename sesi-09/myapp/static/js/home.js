        ...
        build_table: function(people) {
            ...
            if (people) {
                for (let i=0, l=people.length; i < l; i++) {
                    // rows += `<tr><td class="person_id" style="display: none">${people[i].person_id}</td><td class="fname">${people[i].fname}</td><td class="lname">${people[i].lname}</td><td>${people[i].timestamp}</td></tr>`;
...
ns.controller = (function(m, v) {
    ...
    $('#delete').click(function(e) {
        ...
        if (validate('placeholder', 'placeholder')) {
    ...
    $('table > tbody').on('dblclick', 'tr', function(e) {
        ...
        view.update_editor(fname, lname, person_id);
    });
